<!-- Build status badge will be added once CI/CD is configured -->
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

**NOTE: This repository is a modified version of the original EasyBuggy project. The modifications are focused on DevSecOps Tools, Pipeline Security, and other DevSecOps best practices. The original project can be found at https://github.com/k-tamura/easybuggy.**
